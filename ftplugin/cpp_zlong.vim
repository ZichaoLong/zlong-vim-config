...
func! ZLONG_SetSource()
  if &filetype == 'cpp'
    ...
    call append(line(".")+8, "#include<Eigen/Eigen>")
    call append(line(".")+9, "using std::cout; using std::endl; using std::ends;")
    call append(line(".")+10, "using namespace Eigen;")
    call append(line(".")+11, "")
    call append(line(".")+12, "")
    call append(line(".")+13, "int ".expand("%:r"). "( )")
    call append(line(".")+14, "{")
